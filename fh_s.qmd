...
## the direct function of the emdi package here. Other options are e.g. the direct function of package sae or the svyby command of package survey.
...
```{r}
var_smooth <- varsmoothie_king(domain = direct_dt$provlab,
                                 direct_var = direct_dt$vardir,
                                 sampsize = direct_dt$n)
direct_dt <- var_smooth %>% merge(direct_dt, by.x = "Domain", by.y = "provlab")
```
